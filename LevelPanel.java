...
public class LevelPanel extends JPanel{
  ...
  public LevelPanel(GamePanel gp, GridGraph gg) {
    ...
    sidePanel.setLayout(new GridLayout(7,1)); //8,1)); <----------------removing the hint button
    ...
    sidePanel.add(reset);
     ...
     //initialize hint button, adjust design, add listener, add to sidePanel <-------removing the hint button
